<?php
/*
 Program Name  :        checkout.php
 Author name   :        Nick Gulajec
 Date Created  :        May 14, 2013
 Date Modified :        Jun 8, 2013
 Description   :		Users who 'proceed to checkout' from addToCart.php arrive here
 						Prompts for delivery type (take-out, delivery) and method of checkout (guest, login, register)
 						Passes these selections to checkout_step2.php
*/
									...
									<article>
										<form method="post" action="checkout_step2.php">
											<table>
												...
												<tr>
													<td align="right"> 
														Please choose a delivery method:&#160;&#160;&#160;<br>
														<span style="font-style: italic"> Takeout does not have PST &#160;&#160;&#160;&#160;&#160;&#160;</span>
													 </td>
													<td>
												...
												<!--
													If a user is already logged in display appropriate options	
												-->
												<?php
												if (isset($_SESSION['loggedInID'])) {
												?>
